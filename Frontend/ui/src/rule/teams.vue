<template>
  <div class="container">
    <!-- <h1 class="h3 mb-3 fw-normal border-bottom">利用規約</h1> -->
    <h1 class="h1 mb-4 border-bottom">利用規約</h1>
    <p>この利用規約（以下，「本規約」といいます。）は，conforto（以下，「運営者」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</p>

    <h2 class="h3 mb-3">第1条（適用）</h2>
    <ol>
    ...
    <h2 class="h3 mb-3">第3条（ユーザーIDおよびパスワードの管理）</h2>
    <ol>
    ...
    <h2 class="h3 mb-3">第4条（利用料金および支払方法）</h2>
    <ol>
    ...
    <h2 class="h3 mb-3">第6条（本サービスの提供の停止等）</h2>
    <ol>
    ...
    <h2 class="h3 mb-3">第7条（利用制限および登録抹消）</h2>
    <ol>
    ...
    <h2 class="h3 mb-3">第8条（退会）</h2>
    <p>ユーザーは，運営者の定める退会手続により，本サービスから退会できるものとします。</p>

    <h2 class="h3 mb-3">第9条（保証の否認および免責事項）</h2>
    <ol>
