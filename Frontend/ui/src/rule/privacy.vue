<template>
  <div class="container">
    <h1 class="h1 mb-4 border-bottom">プライバシーポリシー</h1>
    <p>conforto（以下，「運営者」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。</p>

    <h2 class="h3 mb-3">第1条（個人情報）</h2>
    <p>「個人情報」とは，個人情報保護法にいう「個人情報」を指すものとし，生存する個人に関する情報であって，当該情報に含まれる氏名，生年月日，住所，電話番号，連絡先その他の記述等により特定の個人を識別できる情報及び容貌，指紋，声紋にかかるデータ，及び健康保険証の保険者番号などの当該情報単体から特定の個人を識別できる情報（個人識別情報）を指します。</p>

    <h2 class="h3 mb-3">第2条（個人情報の収集方法）</h2>
    ...
    <h2 class="h3 mb-3">第3条（個人情報を収集・利用する目的）</h2>
    ...
    <h2 class="h3 mb-3">第4条（利用目的の変更）</h2>
    <ol>
    ...
    <h2 class="h3 mb-3">第5条（個人情報の第三者提供）</h2>
    <ol>
    ...
    <h2 class="h3 mb-3">第6条（個人情報の開示）</h2>
    <ol>
    ...
    <h2 class="h3 mb-3">第7条（個人情報の訂正および削除）</h2>
    <ol>
    ...
    <h2 class="h3 mb-3">第8条（個人情報の利用停止等）</h2>
    <ol>
    ...
    <h2 class="h3 mb-3">第9条（プライバシーポリシーの変更）</h2>
    <ol>
    <li>本ポリシーの内容は，法令その他本ポリシーに別段の定めのある事項を除いて，ユーザーに通知することなく，変更することができるものとします。</li>
    <li>運営者が別途定める場合を除いて，変更後のプライバシーポリシーは，本ウェブサイトに掲載したときから効力を生じるものとします。</li>
    </ol>

    <h2 class="h3 mb-3">第10条（お問い合わせ窓口）</h2>
    <p>本ポリシーに関するお問い合わせは，下記の窓口までお願いいたします。</p>
    <p>
      <!-- 住所：<br>
      社名：<br>
      担当部署：<br> -->
      Eメールアドレス：moreconforto@gmail.com
    </p>
